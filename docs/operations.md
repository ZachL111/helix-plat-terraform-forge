...
`helix-plat-terraform-forge` is centered on platform engineering work in Java. The technical target is: Package a Java local lab for terraform analysis with transition tables, invalid-transition tests, and documented operating limits.
...
The score is deterministic. The current threshold is 154. Risk has a penalty of 6, latency has a penalty of 2, and weight contributes a bonus of 5.
