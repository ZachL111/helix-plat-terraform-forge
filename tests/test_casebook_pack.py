"""Regression checks for the helix-plat-terraform-forge casebook."""
...
from casebook.harness import assert_expected, helix_plat_terraform_forge_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(helix_plat_terraform_forge_summary(), assert_expected())
